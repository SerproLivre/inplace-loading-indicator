...
declare module '@angular/core/metadata/di' {
...
declare module '@angular/core/metadata/directives' {
  /**
 * @license
 ...
 */
  import { ChangeDetectionStrategy } from '@angular/core/change_detection/constants';
  import { Provider } from '@angular/core/di/provider';
  import { Type } from '@angular/core/type';
  import { TypeDecorator } from '@angular/core/util/decorators';
...
declare module '@angular/core/metadata/ng_module' {
  /**
   * @license
   * Copyright Google Inc. All Rights Reserved.
   *
...
declare module '@angular/core/di/forward_ref' {
  /**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
...
declare module '@angular/core/di/metadata' {
  /**
...
declare module '@angular/core/di/reflective_errors' {
  import { Type } from '@angular/core/type';
  import { ReflectiveInjector } from '@angular/core/di/reflective_injector';
  import { ReflectiveKey } from '@angular/core/di/reflective_key';
   ...
   * ```
   */
  export function instantiationError(injector: ReflectiveInjector, originalException: any, originalStack: any, key: ReflectiveKey): InjectionError;
  /**
   ...
   * ```
   */
  export function invalidProviderError(provider: any): Error;
  /**
   ...
   * @stable
   */
  export function outOfBoundsError(index: number): Error;
  /**
...
declare module '@angular/core/di/reflective_injector' {
  /**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 */
  ...
  import { Provider } from '@angular/core/di/provider';
  import { ResolvedReflectiveProvider } from '@angular/core/di/reflective_provider';
  /**
...
declare module '@angular/core/di/reflective_key' {
  /**
...
declare module '@angular/core/di/reflective_provider' {
  import { Self, SkipSelf } from '@angular/core/di/metadata';
  import { Provider } from '@angular/core/di/provider';
  import { ReflectiveKey } from '@angular/core/di/reflective_key';
  /**
...
// declare module '@angular/core/linker/system_js_ng_module_factory_loader' {
//   /**
//  * @license
//  * Copyright Google Inc. All Rights Reserved.
//  *
...
declare module '@angular/core' {
  /**
      ...
      */
  export * from '@angular/core/metadata/di'
  export * from '@angular/core/metadata/directives'
  export * from '@angular/core/metadata/lifecycle_hooks'
  export * from '@angular/core/metadata/ng_module'
  export * from '@angular/core/metadata/view'
  export * from '@angular/core/version';
  export { Class, ClassDefinition, TypeDecorator } from '@angular/core/util/decorators';
  export * from '@angular/core/di/forward_ref'
  export * from '@angular/core/di/injection_token'
  export * from '@angular/core/di/injector'
  export * from '@angular/core/di/metadata'
  export * from '@angular/core/di/provider'
  export * from '@angular/core/di/reflective_errors'
  export * from '@angular/core/di/reflective_injector'
  export * from '@angular/core/di/reflective_key'
  export * from '@angular/core/di/reflective_provider'
  ...
  export * from '@angular/core/zone/ng_zone'
  export * from '@angular/core/render/api'
  export * from '@angular/core/linker/compiler'
  export * from '@angular/core/linker/component_factory'
  export * from '@angular/core/linker/component_factory_resolver'
  export * from '@angular/core/linker/element_ref'
  export * from '@angular/core/linker/ng_module_factory'
  export * from '@angular/core/linker/ng_module_factory_loader'
  export * from '@angular/core/linker/query_list'
  // export * from '@angular/core/linker/system_js_ng_module_factory_loader'
  export * from '@angular/core/linker/template_ref'
  export * from '@angular/core/linker/view_container_ref'
  export * from '@angular/core/linker/view_ref'
  ...
  export * from '@angular/core/change_detection/change_detection'
  export * from '@angular/core/change_detection/change_detection_util'
  export * from '@angular/core/change_detection/change_detector_ref'
  export * from '@angular/core/change_detection/constants'
  export * from '@angular/core/change_detection/pipe_transform'
...
declare module '@angular/core/application_ref' {
  ...
  import { NgModuleFactory, NgModuleRef, CompilerOptions, ComponentFactory, ComponentRef, ComponentFactoryResolver } from '@angular/core';
  /**
      * @license
      * Copyright Google Inc. All Rights Reserved.
      *
...
declare module '@angular/core/core_private_export' {
  ...
  export { global as ɵglobal, looseIdentical as ɵlooseIdentical, stringify as ɵstringify } from '@angular/core/_util';
...
declare module '@angular/core/di/provider' {
  /**
      * @license
      * Copyright Google Inc. All Rights Reserved.
      *
...
declare module '@angular/core/_util' {
  const _global: {
    [name: string]: any;
  };
