...
declare module '@angular/platform-browser' {
  export * from '@angular/platform-browser/browser';
  export * from '@angular/platform-browser/browser/meta';
  export * from '@angular/platform-browser/browser/title';
  export * from '@angular/platform-browser/browser/tools/tools';
  export * from '@angular/platform-browser/dom/debug/by';
  export * from '@angular/platform-browser/dom/debug/ng_probe';
  export * from '@angular/platform-browser/dom/dom_tokens';
  export * from '@angular/platform-browser/dom/events/event_manager';
  export * from '@angular/platform-browser/dom/events/hammer_gestures';
  export * from '@angular/platform-browser/security/dom_sanitization_service';
  export * from '@angular/platform-browser/private_export';
  export * from '@angular/platform-browser/version';
  export * from '@angular/platform-browser/browser/browser_adapter';
  export * from '@angular/platform-browser/browser/location/browser_platform_location';
  export * from '@angular/platform-browser/browser/server-transition';
  export * from '@angular/platform-browser/browser/testability';
  export * from '@angular/platform-browser/dom/dom_adapter';
  export * from '@angular/platform-browser/dom/dom_renderer';
  export * from '@angular/platform-browser/dom/events/dom_events';
  export * from '@angular/platform-browser/dom/events/key_events';
  export * from '@angular/platform-browser/dom/shared_styles_host';
  export * from '@angular/platform-browser/browser/generic_browser_adapter';
  /**
    * @license
